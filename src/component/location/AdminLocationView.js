...
import { getAllLocationOnTransit } from '../../redux/reducer/locationSlice';
import CirculerProgressLoader from '../utility/CirculerProgressLoader';

const AdminLocationIdentifier = () => {
  ...
  useEffect(() => {
    const fetchLocations = async () => {
      setLoading(true);
      try {
        const result = await dispatch(getAllLocationOnTransit()).unwrap();
...
export default AdminLocationIdentifier;