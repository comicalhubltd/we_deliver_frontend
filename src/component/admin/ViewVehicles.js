...
import { getVehicles } from "../../redux/reducer/vehicleSlice";
...
const {  driversCount } = driverState;
  ...
  const rows = Array.isArray(vehicles) ? vehicles : [];
   ...
   const navigateToAddRequestToTransit = (driverId) => {
     navigate(`/delivery/add-request-to-transit/${driverId}`);
  };
                                ...
                                <StyledTableRow key={row.id}>
                                  ...
                                  <StyledTableCell align="left">
                                   ...
                                   <StyledTableCell align="left">
                                    ...
                                    <span className={[dashboard["badge"], dashboard[[row.status === true ? "badge--primary" : "badge--secondary"]]].join(' ')}>{row.status === true ? "Available" : "Not Availbale"}</span>   
                                 
                                  </StyledTableCell>
                                  <StyledTableCell align="right">
                                 <StyledTableCell component="th" align="right">
                      <IconButton onClick={() => navigateToAddRequestToTransit(row.driver?.id)}>
                    <AddCircle sx={{ color: "#018965", fontSize: 30 }} />
                  </IconButton>
                          </StyledTableCell>
                                  </StyledTableCell>
                                </StyledTableRow>
