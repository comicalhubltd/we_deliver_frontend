...
import { getAuthenticatedStudentById } from "../../redux/reducer/driverSlice";
...
const StudentProfile = () => {
  ...
  const fetchStudent = async () => {
    try {
      setIsLoading(true);
      await dispatch(getAuthenticatedStudentById())
        .unwrap()
        .then((result) => {
          console.log(
            "Student profile test: " + JSON.stringify(result.schoolName)
          );
          setState({
            id: result.id,
            ...
            >
              ...
              <List>
                ...
                >
                  ...
                  <div className={navbar["collapsible__content--drawer"]}>
                    <a
                      href="/result/student-search-by-regNo"
                      className={[navbar["link--drawer"], navbar[""]].join(" ")}
                    >
                      Search Result
                    </a>
                ...
                >
                  ...
                  <div className={navbar["collapsible__content--drawer"]}>
                    ...
                    <a
                      href="/password/password-reset-student"
                      className={[navbar["link--drawer"], navbar[""]].join(" ")}
                    >
                      Change Password
                    </a>
