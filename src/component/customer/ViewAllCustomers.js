...
import { getAllCustomers } from "../../redux/reducer/customerSlice";
...
const ViewAllCustomers = () => {
  ...
  const { customers,  fetchingStatus } = customerState;
...
onClick={(e) => e.stopPropagation()}
                    ...
                    <a href="#/driver/assigned-vehicle"   
                     className={[navbar["link--drawer"], navbar[""]].join(" ")}
onClick={(e) => e.stopPropagation()}
                    >
                      Assigned Vehicle
