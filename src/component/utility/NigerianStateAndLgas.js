const statesAndLgas = {
  ...
  "Imo": [
    "Abo-Mbaise","Ahiazu-Mbaise","Ehime-Mbano","Ezinihitte","Ideato North","Ideato South","Ihitte/Uboma",
    "Ikeduru","Isiala Mbano","Isu","Mbaitoli","Ngor-Okpala","Njaba","Nkwerre","Nwangele",
    "Obowo","Oguta","Ohaji/Egbema","Okigwe","Onuimo","Orlu","Orsu","Oru East","Oru West","Owerri Municipal","Owerri North","Owerri West","Unuimo"
  ],
  "Jigawa": [
  ...
  "Kaduna": [
    ...
    "Sabon Gari","Sanga","Soba","Zangon Kataf","Zango"
  ],
  "Kano": [
    "Ajingi","Albasu","Bagwai","Bebeji","Bichi","Dala","Dambatta","Dawakin Kudu","Dawakin Tofa","Doguwa",
    "Fagge","Gabasawa","Garko","Garun Mallam","Gaya","Gezawa","Gwale","Gwarzo","Kabo","Kano Municipal",
  ...
  "Katsina": [
    "Bakori","Batagarawa","Batsari","Baure","Bindawa","Charanchi","Dandume","Danja","Daukar-Mi","Dutsin-Ma",
    "Faskari","Funtua","Ingawa","Jibia","Kafur","Kaita","Kankia","Kankara","Kankia","Katsina","Kurfi",
    "Kusada","Mai’Adua","Malumfashi","Mani","Mashi","Musawa","Rimi","Sabuwa","Safana","Sandamu","Zango"
  ],
  "Kebbi": [
  ...
  "Kogi": [
    ...
    "Kabba/Bunu","Koton Karfe","Lokoja","Mopa-Muro","Ofu","Ogori/Magongo","Okehi","Okene","Olamaboro","Omala","Yagba East","Yagba West"
  ],
  "Kwara": [
    "Asa","Baruten","Edu","Ekiti Kwara (Kaiama)","Ifelodun","Ilorin East","Ilorin South","Ilorin West","Irepodun",
  ...
  "Niger": [
    ...
    "Kontagora","Lapai","Lavun","Magama","Mariga","Mashegu","Mokwa","Muya (or Munya)","Paikoro","Rafi","Rijau","Shiroro","Suleja","Tafa","Wushishi"
  ],
  "Ogun": [
    "Abeokuta North","Abeokuta South","Ado-Odo/Ota","Ewekoro","Ifo","Ijebu East","Ijebu North","Ijebu North East",
    "Ijebu Ode","Ikenne","Imeko Afon","Ipokia","Obafemi-Owode","Odeda","Odogbolu","Ogun Waterside","Remo North","Sagamu","Yewa North","Yewa South"
  ],
  "Ondo": [
    "Akoko North East","Akoko North West","Akoko South East","Akoko South West","Akure North","Akure South","Ese-Odo","Idanre",
  ...
  "Osun": [
    ...
    "Egbedore","Ejigbo","Ife Central","Ife East","Ife North","Ife South","Ila","Ilesa East","Ilesa West","Irepodun",
  ...
  "Oyo": [
    ...
    "Lagelu","Ogbomosho North","Ogbomosho South","Ogo Oluwa","Olorunsogo","Oluyole","Ona-Ara","Orelope","Ori Ire","Oyo East","Oyo West","Saki East","Saki West","Surulere"
  ],
  "Plateau": [
  ...
  "Rivers": [
    "Abua-Odual","Ahoada East","Ahoada West","Akuku Toru","Andoni","Asari-Toru","Bonny","Degema","Eleme","Emuoha","Etche",
    "Gokana","Ikwerre","Khana","Obio/Akpor","Ogba–Egbema–Ndoni","Ogu/Bolo","Okrika","Omuma","Opobo–Nkoro","Oyigbo","Port Harcourt","Tai"
  ],
  "Sokoto": [
  ...
  "Taraba": [
    "Ardo-Kola","Bali","Donga","Gashaka","Gassol","Ibi","Jalingo","Karim-Lamido","Kumi (Kurmi)","Lau","Sardauna","Takum","Ussa","Wukari","Yorro","Zing"
  ],
  "Yobe": [
    "Bade","Bursari","Damaturu","Fika","Fune","Gashua","Gujba","Jakusko","Karasuwa","Machina","Nangere","Nguru","Philip","Tarmuwa","Yunusari","Potiskum"
  ],
  "Zamfara": [
    "Anka","Bakura","Birnin Magaji","Bukkuyum","Gummi","Gusau","Kaura Namoda","Maradun","Maru","Shinkafi","Talata Mafara","Tsafe","Zurmi","Talata Mafara"
  ]
};
