...
const CustomerViewAllRequest = () => {
  ...
  const { customerDeliveryRequests,  fetchingStatus } =
    deliveryState;
  ...
  const rows = Array.isArray(customerDeliveryRequests) ? customerDeliveryRequests : [];
...
export default CustomerViewAllRequest;
