...
import {
  getRejectedDelivery, getAllDelivery
...
const Rejected = () => {
  ...
  const {  rejectedDelivery, allDeliveryRequests,  fetchingStatus } =
    deliveryState;
  ...
  const fetchData = () => {
    dispatch(getRejectedDelivery());
    dispatch(getAllDelivery());
  };

  const rows = Array.isArray(rejectedDelivery) ? rejectedDelivery : [];
