...
import {
   getAwatingTransitDelivery, getAllDelivery
...
const AwaitingTransit = () => {
  ...
  const {   awaitingTransitDelivery, allDeliveryRequests,  fetchingStatus } =
    deliveryState;
  ...
  const rows = Array.isArray(awaitingTransitDelivery) ? awaitingTransitDelivery : [];
...
export default AwaitingTransit;
