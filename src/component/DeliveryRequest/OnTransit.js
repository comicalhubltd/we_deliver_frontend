...
import {
 getOnTransitDelivery, getAllDelivery
...
const OnTransit = () => {
  ...
  const { onTransitDelivery,  allDeliveryRequests,  fetchingStatus } =
    deliveryState;
  ...
  const rows = Array.isArray(onTransitDelivery) ? onTransitDelivery : [];
