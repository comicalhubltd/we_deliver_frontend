...
import { getAllDelivery } from "../../redux/reducer/deliveryRequestSlice";
...
const ViewAllRequest = () => {
  ...
  const { allDeliveryRequests,  fetchingStatus } =
    deliveryState;
  ...
  const rows = Array.isArray(allDeliveryRequests) ? allDeliveryRequests : [];
